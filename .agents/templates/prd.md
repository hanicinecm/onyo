...
Use this template to capture the high-level intent, boundaries, and guiding decisions for a hobby-scale Python project. It is meant to orient contributors and frame future Feature PRDs without locking in implementation detail too early.
